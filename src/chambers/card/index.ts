import { CardChamberEl } from "./CardChamber";
...
if (!customElements.get("sae-card-chamber"))  customElements.define("sae-card-chamber", CardChamberEl);
if (!customElements.get("sae-card-bg")) customElements.define("sae-card-bg", CardBGEl);
if (!customElements.get("sae-gesture-layer")) customElements.define("sae-gesture-layer", GestureLayerEl);
