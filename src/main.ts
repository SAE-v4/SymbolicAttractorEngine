...
import {
  SOLAR_SPIRAL_CFG, SOLAR_RING_CLOCK, SOLAR_TRAVELER_CFG, SOLAR_WITNESS_CFG, SOLAR_VISUALS
...
const breathCfg: BreathConfig = {
  mode: "freeRun",
  rateBPM: 9,
  shape: { inhaleRatio: 0.45, holdIn: 0.05, exhaleRatio: 0.45, holdOut: 0.05,
...
hud.className = "hud";
hud.style.cssText = "position:fixed;left:12px;bottom:12px;color:#9ecbff;font:12px/1.2 monospace;background:#0a1422cc;padding:8px 10px;border-radius:8px;z-index:99";
